...
for(let item of cellular){
    switch(item.Predict){
        ...
        case 'Endoplasmic_reticulum':
            num.Endoplasmic_reticulum += 1;
            break;
        case 'Golgi_apparatus':
            num.Golgi_apparatus += 1;
            break;
        case 'Chloroplast':
            num.Chloroplast += 1;
            break;
...
// ============================
// Create cell_image Components
// ============================
var container_summaryCell = document.createElement("container");
mainContainer.appendChild(container_summaryCell);
var cell = document.createElement("div");
container_summaryCell.appendChild(cell);
cell.classList.add("card");
cell.classList.add("mt-2");
cell.classList.add("container_cellImage");

var cell_img = document.createElement("img");
cell_img.src = "../public/images/cell_name2.png";
cell_img.classList.add("cell_image");
cell.appendChild(cell_img);
// add number element

for(let item in num){
    var number_element = document.createElement("span");
    number_element.setAttribute("id",item)
    number_element.classList.add("number_"+item);
    number_element.classList.add("number_cell");
    number_element.innerHTML=num[item];
    number_element.onclick = function (){
        console.log(item)
    }
    cell.appendChild(number_element);
}

var container_sequence = document.createElement("container");
mainContainer.appendChild(container_sequence);

$(".selectpicker").change(function () {
  var idList = $(".selectpicker").val();
  console.log(idList);
  container_sequence.innerHTML = "";

  for (var i = 0; i < idList.length; i++) {
    var id = idList[i];
    var container = document.createElement("container");
    container_sequence.appendChild(container);
    ...
    cellularBtn.textContent =
      "Sub Cellular Prediction: " + cellular[id].Predict.replace(/_/g, " ");
    ...
    organellarBtn.textContent =
      "Sub Organellar Prediction: " +
      organellar[id].Prediction.replace(/_/g, " ");
    ...
    organellarChartContainer.setAttribute(
      "id",
      "organellarChartContainer_" + id
    );
  ...
  intro.setOptions({
    steps: [
      ...
      },
      {
        ...
        intro:
          "The name of current sequence. Click to display the detail of this sequence.",
      },
      {
        element: document.querySelector("#cellular_heading_0"),
        intro:
          "Click to show/hide the chart of sub-cellular prediction results. You can drag to zoom and click menu button to print/save the chart.",
      },
      {
        element: document.querySelector("#organellar_heading_0"),
        intro:
          "Click to show/hide the chart of sub-organellar prediction results. You can drag to zoom and click menu button to print/save the chart.",
      },
      {
        element: document.querySelector("#weights_heading_0"),
        intro:
          "Click to show/hide the chart of attention weights. You can drag to zoom and click menu button to print/save the chart.",
      },
      {
        intro:
          "Click the right bottom button(if appear) to scroll to the top of this page.",
      },
      {
        intro:
          "Click the left side button to show the side nav bar including selected results. You can click specific result to scroll to it.",
      },
    ],
  });
