...
# [dic_id2att,dic_id2pred,dic_id2seq]=readData("/home/yuexu/localization_clean/reduce_plastid/attention_weights.txt",
#                                              "/home/yuexu/localization_clean/reduce_Plastid_seq.fasta",
#                                              "/home/yuexu/localization_clean/reduce_plastid/sub_cellular_prediction.txt")
#
# loopLoc(dic_id2pred,"/home/yuexu/localization_clean/reduce_plastid/",dic_id2att, dic_id2seq)
...
def main():
    parser=argparse.ArgumentParser(description='Attention analysis for MULocDeep')
    parser.add_argument('-att',  dest='attention_weights', type=str, help='attention weights calculated from MULocDeep',
                        required=True)
    parser.add_argument('-seq',  dest='sequence', type=str, help='input sequences for the prediction', required=True)
    parser.add_argument('-lv1_pred', dest='lv1_prediction', type=str,
                        help='the subcellular prediction', required=True, default="")
    parser.add_argument('-jobdir', dest='job_dir', type=str, help='the directory of the job folder', required=True, default="")
    parser.set_defaults(feature=True)
    args = parser.parse_args()
    attfile=args.attention_weights
    seqfile=args.sequence
    predfile=args.lv1_prediction
    jobdir=args.job_dir
